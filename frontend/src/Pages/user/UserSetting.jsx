    ...
    <form className="profile-form">
      <div className="section-title2">
        <h5 className="d-flex align-items-baseline gap-1">
          <img src="/../../../public/assets/images/icon/profile-settings.svg" alt="" /> Profile
          Settings{" "}
        </h5>
      </div>
          ...
          <div className="col-md-6">
            <div className="form-inner mb-25">
              ...
              <div className="input-area">
                <img src="/../../../public/assets/images/icon/lock-2.svg" alt="" />
                <input
                  type="password"
                  name="password"
                  id="password"
        ...
        <div className="row">
          ...
          <div className="col-md-6">
            <div className="form-inner mb-25">
              ...
              <div className="input-area">
                <img src="/../../../public/assets/images/icon/phone-2.svg" alt="" />
                <input
                  type="text"
                  id="pphonenumber"
                  name="pphonenumber"
        ...
        <div className="row">
          ...
          <div className="col-md-12">
            <div className="form-inner mb-25">
              ...
              <div className="input-area">
                <img src="/../../../public/assets/images/icon/map-2.svg" alt="" />
                <input
                  type="text"
                  id="location"
                  name="location"
          ...
          <div className="col-lg-12">
            ...
            <div className="single-permission mb-3">
              <div className="title">
                ...
                <p>
                  If you log in again you will able to see all the match jobs
            ...
            <div className="single-permission align-items-start">
              <div className="title">
                ...
                <p>
                  ...
                  information about the matched jobs.
                </p>
              </div>
