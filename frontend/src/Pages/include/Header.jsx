    ...
    <>
      <header className="header-area style-1">
        <div className="header-main-logo d-lg-block d-none">
          <Link to="index.html">
            <img alt="" src="/assets/images/header1-logo.svg" />
          </Link>
        </div>
        <div className="menu-topbar-area">
          <div className="top-bar">
            <p>
              Welcome Our Job Portal! <Link to="bookmark.html">Save Jobs</Link>
            </p>
            <div className="top-bar-right">
              <div className="language-select">
                <img src="/assets/images/icon/flag-eng.svg" alt="" />
                <span>Language</span>
                <ul className="topbar-sublist">
                  <li>
                    <img src="/assets/images/icon/flag-germeny.svg" alt="" />
                    <span>Germeny</span>
                  </li>
                  <li>
                    <img src="/assets/images/icon/flag-french.svg" alt="" />
                    <span>French</span>
                  </li>
                  <li>
                    <img src="/assets/images/icon/flag-bangla.svg" alt="" />
                    <span>Bengali</span>
                  </li>
                </ul>
              </div>
            ...
            <div className="main-menu">
              ...
              <div className="for-mobile-menu d-lg-none d-block">
                <div className="sign-in-btn mb-25">
                  <Link className="primry-btn-1 lg-btn" to="/login">
                    <svg
                      width={15}
                      height={15}
                      viewBox="0 0 15 15"
                ...
                <div className="post-job-btn mb-30">
                  <Link className="primry-btn-2 lg-btn" to="#">
                    <svg
                      width={15}
                      height={13}
                      viewBox="0 0 15 13"
              ...
              <ul>
                  ...
                  <div className="btn-group dropdown">
                    ...
                    >
                      ...
                      <ul>
                        <li>
                          ...
                          <div className="content">
                            <h6>
                              <button style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, font: 'inherit', textDecoration: 'underline', color: 'inherit' }}>
                      ...
                      <div className="view-all">
                        <button style={{ background: 'none', border: 'none', cursor: 'pointer', padding: 0, font: 'inherit', textDecoration: 'underline', color: 'inherit' }}>See All Notifications</button>
                      </div>
                    </div>
                  </div>
                </li>
                ...
                <li className="d-md-flex d-none">
                  <div className="post-job-btn">
                    <Link className="primry-btn-2 lg-btn" to="/post-job">
                      Post Job
                      <svg
                        width={15}
                        height={13}
