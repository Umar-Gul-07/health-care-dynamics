...
function Header() {
  ...
  <div className="menu-topbar-area">
    <div className="top-bar">
      <p>
        Welcome Our Job Portal! <a href="bookmark.html">Save Jobs</a>
      </p>
      ...
      <div className="main-menu">
        ...
        <ul className="menu-list">
          ...
          <li className="menu-item-has-children">
            ...
            <ul className="sub-menu">
              ...
              <li>
                <a href="job-listing1.html">Job Listing 01</a>
              </li>
              <li>
                <a href="job-listing2.html">Job Listing 02</a>
              </li>
              <li>
          ...
          <li className="menu-item-has-children">
            ...
            <ul className="sub-menu">
              ...
              <li>
                <a href="job-post.html">Post A Jobs</a>
              </li>
              <li>
          ...
          <li className="menu-item-has-children">
            ...
            <ul className="sub-menu">
              <li>
                <a href="company-listing1.html">Company Listing 01</a>
              </li>
              <li>
                <a href="company-listing2.html">Company Listing 02</a>
              </li>
              <li>
        ...
        <div className="for-mobile-menu d-lg-none d-block">
          <div className="sign-in-btn mb-25">
            <a className="primry-btn-1 lg-btn" href="login.html">
              <svg
                width={15}
                height={15}
                viewBox="0 0 15 15"
        ...
        <ul>
          ...
          <li className="d-md-flex d-none">
            <div className="post-job-btn">
              <a className="primry-btn-2 lg-btn" href="job-post.html">
                Post Job
                <svg
                  width={15}F
                  height={13}
