    ...
    <div className="row g-lg-4 gy-5">
      <div className="col-lg-6">
        <div className="contect-content">
          ...
          <p>
            Alternatively you can also check for the Company email, phone number
            and address in the official website.
          </p>
        ...
        <div className="contact-form form-wrapper">
          <form>
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="form-inner mb-25">
                  <label htmlFor="jobplace">Company Name (Optional)</label>
                  <div className="input-area">
