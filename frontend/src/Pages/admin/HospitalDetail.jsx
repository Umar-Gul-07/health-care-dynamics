        ...
        <div className="row">
          <div className="col-lg-8">
            <div className="company-details-content">
              ...
              <p>
                ...
                productivity tools, or games, while others develop a range of
                software products. Many software companies also offer services
                such as custom software development, consulting, and technical
                support to their customers. The size and scope of software
                companies can vary greatly, from small startups to large
                ...
                <div className="col-sm-6 mb-50">
                  <div className="working-process">
                    ...
                    <div className="work-content">
                      ...
                      <p>
                        Creative design is a process that involves creating.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="col-lg-4">
            <div className="company-dt-sb mb-60">
              ...
              <a className="primry-btn-2 lg-btn" href="job-listing1.html">
                Job Available 23
              </a>
              <a
              ...
              <div className="job-list-content">
                <div className="company-area">
                  ...
                  <div className="company-details">
                    <div className="name-location">
                      ...
                      <p>
                        <a href="company-details.html">Medico.co Ltd</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div className="job-discription">
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        <span className="title">Published:</span> 05 April, 2023
                      </p>
                    </li>
                  </ul>
                </div>
              ...
              <div className="job-list-content">
                <div className="company-area">
                  ...
                  <div className="company-details">
                    <div className="name-location">
                      <h5>
                        <a href="job-details.html">Senior PHP Developer</a>
                      </h5>
                      <p>
                        <a href="company-details.html">Marko Land Conpany</a>
                      </p>
                    </div>
                  </div>
                </div>
                <div className="job-discription">
                  ...
                  <ul>
                    ...
                    <li>
                      <p>
                        <span className="title">Published:</span> 08 April, 2023
                      </p>
                    </li>
                  </ul>
                </div>
              ...
              <div className="job-list-content">
                <div className="company-area">
                  ...
                  <div className="company-details">
                    <div className="name-location">
                      <h5>
                        <a href="job-details.html">Junior React Developer</a>
                      </h5>
                      <p>
              ...
              <div className="job-list-content">
                <div className="company-area">
                  ...
                  <div className="company-details">
                    <div className="name-location">
                      <h5>
                        <a href="job-details.html">Senior React Developer</a>
                      </h5>
                      <p>
                        <a href="company-details.html">UI.UX Company</a>
                      </p>
