          ...
          <div className="form-inner">
            ...
            <div className="select-area">
              ...
              <div className="nice-select select1" tabIndex={0}>
                <span className="current">05</span>
                <ul className="list">
                  <li data-value={5} className="option selected">
                    05
                  </li>
      ...
      <tbody>
        <tr>
          ...
          <td data-label="Action">
            <ul className="action-btn-group2">
              <li>
                <a
                  href="job-details-for-company.html"
        ...
        <tr>
          <td data-label="Job Title">
            <div className="job-content">
              <h5>
                <a href="job-details-for-company.html">Senior React Native </a>
              </h5>
              <p>
                <img src="assets/images/icon/calender2.svg" alt="" />
                <span>Deadline:</span> 02 April, 2023
        ...
        <tr>
          <td data-label="Job Title">
            <div className="job-content">
              <h5>
                <a href="job-details-for-company.html">WordPress Developer</a>
              </h5>
              <p>
                <img src="assets/images/icon/calender2.svg" alt="" />
                <span>Deadline:</span> 02 April, 2023
