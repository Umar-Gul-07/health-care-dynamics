          ...
          <tbody>
                                ...
                                <div className="resume-area">
                                    ...
                                    <div className="single-information-area">
                                      ...
                                      <div className="description">
                                        <p>
                                          ...
                                          tackle various needs from landing page
                                          designs, web app interfaces. I have
                                          skills in User Experience Design
                                          (UXD), user-centered Design,
                                          Interaction and Visual Design for
                                          websites, applications, web, and
                                          mobile products, wireframes, mock-ups,
                                          qualitative and quantitative user
                                          studies, usability analysis, and
                                          informal usability audits.
                                        </p>
                                      </div>
                                    </div>
                                  </div>
                                          ...
                                          <div className="responsibility">
                                            ...
                                            <ul>
                                              ...
                                              <li>
                                                ...
                                                design enhancements, and overall
                                  ...
                                  <div className="col-lg-12">
                                    <div className="declaration-area">
                                      ...
                                      <p>
                                        I do hereby declare that the information
                                        given above is true of my knowledge.
                                      </p>
                                    </div>
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  <div className="employee-img">
                    <img src="assets/images/bg/employee-img2.png" alt="" />
                  </div>
                  <div className="employee-content">
                    <button
                      type="button"
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  <div className="employee-img">
                    <img src="assets/images/bg/employee-img3.png" alt="" />
                  </div>
                  <div className="employee-content">
                    <button
                      type="button"
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  <div className="employee-img">
                    <img src="assets/images/bg/employee-img4.png" alt="" />
                  </div>
                  <div className="employee-content">
                    <button
                      type="button"
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  <div className="employee-img">
                    <img src="assets/images/bg/employee-img5.png" alt="" />
                  </div>
                  <div className="employee-content">
                    <button
                      type="button"
            ...
            <tr>
              <td data-label="Candidate Name">
                <div className="employee-info">
                  <div className="employee-img">
                    <img src="assets/images/bg/employee-img6.png" alt="" />
                  </div>
                  <div className="employee-content">
                    <button
                      type="button"
